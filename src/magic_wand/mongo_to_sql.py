...
def parse_player(player_data):
    columns = ["match_id", "player_slot", "account_id", "assists", "deaths", "denies", "firstblood_claimed",
               ...
               "personaname", "name", "radiant_win", "start_time", "duration", "patch", "region", "win", "total_gold",
               "total_xp",
               "kills_per_min", "kda", "neutral_kills", "game_mode", "tower_kills", "courier_kills", "lane_kills",
               "hero_kills", "observer_kills",
               "sentry_kills", "roshan_kills", "necronomicon_kills", "ancient_kills", "buyback_count", "observer_uses",
               "sentry_uses",
               "lane_efficiency", "lane_efficiency_pct", "lane", "lane_role", "purchase_tpscroll", "actions_per_min",
               "rank_tier"]
